...
const TestimonialsCard: React.FC<TestimonialsCardProps> = ({ testimonial }) => {
    return (
        <div className='w-full h-full flex items-center'>
            <div
                key={testimonial.id}
                className="w-6/7 h-7/8 mx-auto bg-base-100 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl"
            >
                <div className="card-body">
                    ...
                    <p className="text-base-content/80 text-center italic leading-relaxed mb-2">
                        "{testimonial.message}"
                    </p>
